...
class Ceton_HTML():
    ...
    def __init__(self, fhdhr, plugin_utils):
        ...
        self.hwtype = self.plugin_utils.origin.get_ceton_getvar(0, "HostConnection")
    ...
    def get(self, *args):
        ...
        if self.origin.setup_success:
            ...
            origin_status_dict["HostHardware"] = self.plugin_utils.origin.get_ceton_getvar(0, "HostHardware")
            origin_status_dict["HostFirmware"] = self.plugin_utils.origin.get_ceton_getvar(0, "HostFirmware")
            origin_status_dict["HostSerial"] = self.plugin_utils.origin.get_ceton_getvar(0, "HostSerial")
            ...
            for i in range(int(self.fhdhr.config.dict["ceton"]["tuners"])):
                ...
                origin_status_dict["Tuner"+str(i)]['BER'] = self.plugin_utils.origin.get_ceton_getvar(i, "Signal_BER")
                origin_status_dict["Tuner"+str(i)]['Modulation'] = self.plugin_utils.origin.get_ceton_getvar(i, "Signal_Modulation")
        else:
